<?php
    ...
    require $initalUrl . 'vendor/phpmailer/src/Exception.php';
    require $initalUrl . 'vendor/phpmailer/src/PHPMailer.php';
    require $initalUrl . 'vendor/phpmailer/src/SMTP.php';
