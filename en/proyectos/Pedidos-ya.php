            ...
            <div class="container">
                <article class="project-style-4 mb-4 pb-4">
                    <header class="entry-header">
                        <h2 class="entry-title">Pedidos-ya</h2>
                    </header>
                    <div class="masonry-row js-isotope-wrapper">
                        <div class="row isotope-content">
                            <div class="col-md-6 col-lg-4 isotope-item isotope-item-sizer">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Pedidos-ya/Pedidos-ya1.jpg" alt="Post 1">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Pedidos-ya/Pedidos-ya2.jpg" alt="Post 2">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Pedidos-ya/Pedidos-yaV.jpg" alt="Post 3">
                            </div>
                            <div class="col-lg-8 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Pedidos-ya/portadaPedidos-ya.jpg" alt="Post 4">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Pedidos-ya/Pedidos-ya3.jpg" alt="Post 5">
                            </div>
                        </div>
                    </div>
