                    ...
                    <div class="masonry-row js-isotope-wrapper">
                        <div class="row isotope-content">
                            <div class="col-md-6 col-lg-4 isotope-item isotope-item-sizer">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Asapp/ImgAsapp1.jpg" alt="Post 1">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Asapp/ImgAsapp2.jpg" alt="Post 2">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Asapp/ImgAsapp3.jpg" alt="Post 3">
                            </div>
                            <div class="col-lg-8 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Asapp/portadaAsapp.jpg" alt="Post 4">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Asapp/ImgAsapp4.jpg" alt="Post 5">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="entry-meta__item">
                                            ...
                                            <span class="value">1200sqft.</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="entry-meta__item">
