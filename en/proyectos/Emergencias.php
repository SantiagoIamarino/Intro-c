                    ...
                    <div class="masonry-row js-isotope-wrapper">
                        <div class="row isotope-content">
                            <div class="col-md-6 col-lg-4 isotope-item isotope-item-sizer">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Emergencias/ImgEmergencias1.jpg" alt="Post 1">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Emergencias/ImgEmergencias2.jpg" alt="Post 2">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Emergencias/ImgEmergenciasV.jpg" alt="Post 3">
                            </div>
                            <div class="col-lg-8 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Emergencias/portadaEmergencias.jpg" alt="Post 4">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Emergencias/ImgEmergencias3.jpg" alt="Post 5">
                            </div>
                        </div>
                    </div>
