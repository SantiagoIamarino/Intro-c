                    ...
                    <div class="masonry-row js-isotope-wrapper">
                        <div class="row isotope-content">
                            <div class="col-md-6 col-lg-4 isotope-item isotope-item-sizer">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Belatrix/ImgBelatrix1.jpg" alt="Post 1">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Belatrix/ImgBelatrix2.jpg" alt="Post 2">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Belatrix/ImgBelatrixV.jpg" alt="Post 3">
                            </div>
                            <div class="col-lg-8 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Belatrix/portadaBelatrix.jpg" alt="Post 4">
                            </div>
                            <div class="col-md-6 col-lg-4 isotope-item">
                                <img class="wp-post-image" data-fancybox="gallery" src="../../imagenes/Belatrix/ImgBelatrix3.jpg" alt="Post 5">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="entry-meta__item">
                                            ...
                                            <span class="value">2000sqft.</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="entry-meta__item">
