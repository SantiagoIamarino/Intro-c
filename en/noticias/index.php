<?php 
    ...
    $query = "SELECT * FROM posts WHERE category = 'noticia' ";
    $countQuery = "SELECT COUNT(*) as total FROM posts WHERE category = 'noticia' ";
...
<head>
    ...
    <!-- Title Page-->
    <title>Noticias | Intro Arquitectura</title>
            ...
            <section class="section p-t-100 p-b-65">
                <div class="container">
                    <div class="page-heading">
                        <h4 class="title-sub title-sub--c8 m-b-15">News</h4>
                        <h2 class="title-2">Last News</h2>
                    </div>
                </div>
            </section>
            <!-- END PAGE HEADING-->
